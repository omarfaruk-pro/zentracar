    ...
    <>
      <section className="py-20">
        <div className="xl:max-w-7xl lg:max-w-5xl md:max-w-3xl sm:max-w-xl px-5 mx-auto">
          ...
          <div className="flex flex-col lg:flex-row  justify-between gap-3 border-1 border-gray-700 dark:border-gray-100 rounded-lg p-3 shadow-sm sm:sticky sm:top-26 z-40 bg-[#1D232A] dark:bg-white">
            ...
            <div className="flex justify-start sm:justify-center flex-wrap gap-3">
              ...
              <button onClick={() => setLayout(!layout)} className="text-xl p-1.5 border-1 border-gray-700 dark:border-gray-100 shadow-lg rounded-sm h-10 w-10 flex items-center justify-center">{layout ? <CiGrid42 /> : <FaList />}</button>
            </div>
          </div>
          {
            isLoading ? (
