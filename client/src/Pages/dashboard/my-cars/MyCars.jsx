        ...
        <div className="xl:max-w-7xl lg:max-w-5xl md:max-w-3xl sm:max-w-xl px-5 mx-auto">
                  ...
                  <table className="table ">
                    <thead>
                      <tr>
                        ...
                        <th className="px-2 text-center">Availability</th>
                        <th className="px-2 text-center">Booking</th>
                            ...
                            <tr key={index}>
                              ...
                              <td className="px-2">
                                <div className="flex gap-4 items-center">
                                  <div>
                                    <img className="w-20 h-20 aspect-square object-cover rounded-sm" src={car.imageUrl} alt={car.carName} />
                                  </div>
                                  <div>
                              ...
                              <td className="px-2">
                                <div className="flex gap-2 justify-center">
                                  <Link to={`/dashboard/manage-booking/${car._id}`} data-tooltip-id="view" data-tooltip-content="View Booking" type="button" className="btn bg-white text-gray-950 btn-sm text-base"><FaRegEye /></Link>
          ...
          </div>
          {
            updateCar && (
              ...
              <div data-attribute="modal" onClick={(e) => handleModal(e)} className={`h-screen w-screen bg-[#000000a5] fixed top-0 left-0 flex justify-center items-center z-60 py-10 duration-300 ease-linear ${modal ? 'visible opacity-100' : 'invisible opacity-0'}`}>
